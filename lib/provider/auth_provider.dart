...
import 'package:gantavya/Activity/Otp.dart';
...
class AuthProvider extends ChangeNotifier {
  ...
  void checkSign() async {
    final SharedPreferences s = await SharedPreferences.getInstance();
    _isSignedIn = s.getBool("is_signedin") ?? false;
    print("ttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt");
    notifyListeners();
  }
